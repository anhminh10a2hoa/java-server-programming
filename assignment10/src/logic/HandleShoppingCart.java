...
// Here we get access to the shopping cart
        ...
        if (action.equalsIgnoreCase("Empty Cart")) {
            if (session != null) {
            	...
            	Cookie userCookie = new Cookie("ShoppingCart", "");
        ...
        Cookie userCookie = new Cookie("ShoppingCart", shoppingCart.getAllProduct());
        response.addCookie(userCookie);
        ...
        out.println("<p style='text-align: center;'><a href='/assignment10/checkout'>Check out</a></p>");
